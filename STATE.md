...
Last_Action: Fixed lobby seat swap (unique-constraint collision when both seats occupied) by swapping occupants in place; tap-to-select swap with optimistic UI, seat 0 locked.
Next_Actions:
