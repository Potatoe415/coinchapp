...
- [ ] Generalize `useP2PHost.ts`/`useP2PBouillaHost.ts`/`useP2PPresidentHost.ts` (now 3 parallel ~200-line files, never generalized even at N=3 - accepted trade-off when Président shipped, see DECISIONS 2026-09-10).
